package com.gns.recyclerviewcommands;
...
import com.gns.recyclerviewcommands.databinding.ActivityMainBinding;
import com.gns.recyclerviewcommands.databinding.RecyclerviewRowBinding;
...
public class ListRecycler extends RecyclerView.Adapter<ListRecycler.ListHolder> {
    ...
    public ListRecycler(List<ListModal> list, ActivityMainBinding activityMainBinding) {
        this.list = list;
