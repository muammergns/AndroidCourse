package com.gns.androidcourse.animatorandanimations;
...
import com.gns.androidcourse.databinding.ActivityAnimatorAndAnimationsBinding;

public class AnimatorAndAnimationsActivity extends AppCompatActivity {

    ActivityAnimatorAndAnimationsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAnimatorAndAnimationsBinding.inflate(getLayoutInflater());
